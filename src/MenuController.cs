...
static class MenuController
{
	...
	private static void DrawButtons(int menu, int level, int xOffset)
	{
		...
		for (i = 0; i <= _menuStructure[menu].Length - 1; i++) {
			...
			SwinGame.DrawTextLines(_menuStructure[menu][i], MENU_COLOR, Color.Black, 
			GameResources.GameFont("Menu"), FontAlignment.AlignCenter, btnLeft + TEXT_OFFSET, 
			btnTop + TEXT_OFFSET, BUTTON_WIDTH, BUTTON_HEIGHT);
